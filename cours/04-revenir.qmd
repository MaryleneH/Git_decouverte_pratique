...
```
```text
[main 9c8d7e6] Revert "Modifie le calcul de l'indicateur"
...
<ol class="git-timeline" data-animate="timeline">
  <li class="tl-commit">
    ...
    <span class="tl-msg">Revert "Modifie le calcul de l'indicateur"</span>
    <span class="tl-meta">Le commit d'annulation : le calcul revient à la version validée.</span>
  </li>
  <li class="tl-commit">
    <span class="tl-hash">8f31c2a</span>
    <span class="tl-msg">Modifie le calcul de l'indicateur</span>
    <span class="tl-meta">L'erreur — toujours visible, assumée, documentée.</span>
  </li>
  <li class="tl-commit">
    <span class="tl-hash">51bd882</span>
    <span class="tl-msg">Version stable avant modification</span>
    <span class="tl-meta">La version validée.</span>
  </li>
</ol>
```
